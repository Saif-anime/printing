...
if($_GET['id']){
    ...
    $sql = "SELECT * FROM `computer_add` WHERE id='$ids'";
...
?>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" name="price" value="<?php echo $f['price'] ?>" class="form-control">
                </div>
            </div>
                ...
                <div class="col-sm-10">
                    <div class="col-md-12">
                        <select name="cate" id="paper_size" class="form-control">
                            ...
                            <?php
if($f['cate'] == 'Computer'){
    echo "<option selected>Computer</option>";
}
if($f['cate'] == 'Keyboard'){
    echo "<option selected>Keyboard</option>";
}
if($f['cate'] == 'Mouse'){
    echo "<option selected>Mouse</option>";
}
if($f['cate'] == 'Others'){
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   if(isset($_FILES['file'])){
    ...
    $sql = "UPDATE `computer_add` SET `img`='$upload_dir',`price`='$price',`title`='$title',`cate`='$cate' WHERE id='$ids'";
    $sql_run = mysqli_query($conn, $sql);

    if($sql_run){
        echo "<script>window.location.href = 'computer_all.php'</script>";
    }else{
        echo "<script>window.location.href = 'computer_all.php'</script>";
    }
    ...
    $sql = "UPDATE `computer_add` SET `price`='$price',`title`='$title',`cate`='$cate' WHERE id='$ids'";
    $sql_run = mysqli_query($conn, $sql);
