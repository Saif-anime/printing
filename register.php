...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($row>0){
        ...
        <strong>Email Already Exist
        !</strong> please go login first
    ...
    $sql = "INSERT INTO `users`(`name`, `email`, `number`, `pass`, `is_admin`) VALUES ('$fullname','$email','$phone','$pass','0')";
    $sql_run = mysqli_query($conn, $sql);

    if($sql_run){
        echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
        <strong>Hooray Congratulation.
        !</strong> Register Successfull.
        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div>";
    }else{
        echo "<div class='alert alert-danger alert-dismissible fade show' role='alert'>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-12">
                                    <input type="password" name="pass" class="form-control"
                                        placeholder="Set the Password" required="">
                                </div>
