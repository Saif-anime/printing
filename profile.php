...
if($_GET['id']){
    ...
    $sql = "SELECT * FROM `users` WHERE id='$ids' AND is_admin='0' AND is_email_verify='1'";
    $sql_run = mysqli_query($conn, $sql);
                    ...
                    <div class="col-lg-6">
                        <form method="post" class="php-email-forms" data-aos="fade-up" data-aos-delay="200">
                            <div class="row gy-4">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $f['name']; ?>" name="name"
                                        class="form-control" placeholder="Your Name" required="">
                                </div>

                                <div class="col-md-12">
                                    <input type="email" value="<?php echo $f['email']; ?>" class="form-control"
                                        name="email" placeholder="Your Email" required="">
                                </div>

                                <div class="col-md-12">
                                    <input type="number" value="<?php echo $f['number']; ?>" class="form-control"
                                        name="phone" placeholder="Your Phone Number" required="">
                                </div>
                                <div class="col-md-12">
                                    <input type="text" name="pass" value="<?php echo $f['pass']; ?>"
                                        class="form-control" placeholder="Change the Password" required="">
                                </div>
                                ...
                                <!-- <a href="login.php" class="text-center">Have you account please go login ?</a> -->
